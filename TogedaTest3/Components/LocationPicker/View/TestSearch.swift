...
//  TogedaTest3
//
//  Created by Borislav Lorinkov on 24.05.24.
//
                ...
                List(placeVM.places){ place in
                    HStack{
                        ...
                        VStack(alignment: .leading) {
                            Text("Country: \(place.mapItem.placemark.country ?? "No country")")
                                .font(.title2)
                                .fontWeight(.semibold)
...
#Preview {
    TestSearch(returnedPlace: .constant(Place(mapItem: MKMapItem())), isActivePrev: .constant(true))
