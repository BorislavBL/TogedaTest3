...
extension Post {
    static var MOCK_POSTS: [Post] = [
        ...
        .init(id: NSUUID().uuidString, ownerId: users[1].id, title: "Beach Volleyball", imageUrl: ["event_2", "event_2", "event_3"], description: postDescription, peopleIn: [users[1].id, users[5].id], maximumPeople: 10, location: PostLocation(latitude: 42.643954, longitude: 23.355198), date: Date(), category: "Sport", createdAt: Date(), interests: ["hiking", "outdoors", "activity", "social"], user: users[1], payment: 0, participants: [users[1], users[2]], type: "public", accessability: .Public, hasEnded: false),
        .init(id: NSUUID().uuidString, ownerId: users[2].id, title: "Skating at the hilton park", imageUrl: ["event_3", "event_2", "event_3"], description: postDescription, peopleIn: [users[2].id, users[4].id], maximumPeople: 10, location: PostLocation(latitude: 42.633954, longitude: 23.386198), date: Date(), category: "Sport", createdAt: Date(), interests: ["hiking", "outdoors", "activity", "social"], user: users[2], payment: 3.76, participants: [users[1], users[3]], type: "private", accessability: .Public, hasEnded: false),
